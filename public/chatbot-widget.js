(function () {
  ...
  const css = `
    ...
    #__chatbot-fab:hover { transform: scale(1.05); box-shadow: 0 6px 20px rgba(37,99,235,0.5); }
    #__chatbot-panel {
    ...
    #__chatbot-header {
      background: #2563eb; color: white; padding: 14px 16px;
    ...
    #__chatbot-input:focus { border-color: #2563eb; }
    #__chatbot-send {
    ...
    #__chatbot-send:hover { background: #1d4ed8; }
    #__chatbot-send:disabled { background: #93c5fd; cursor: default; }
  `;
