        ...
        <div className="space-y-2 mb-5">
          ...
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 3C6.477 3 2 6.477 2 10.8c0 2.7 1.7 5.08 4.27 6.51l-1.09 4.04a.3.3 0 0 0 .44.33L10.3 19.1A11.2 11.2 0 0 0 12 19.2c5.523 0 10-3.134 10-7S17.523 3 12 3z"/>
            </svg>
            카카오로 로그인
          </button>
